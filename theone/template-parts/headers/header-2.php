<?php 
    $theone_trn_header_logo = '';
    $theone_trn_header_logo_width = '130';
    ...
    if (defined('FW')) {
        ...
        if ( is_page() && $theone_transparent_menu_switch == 'on') {
            $theone_menu_bg_color = $theone_page_header_style_picker['on']['theone_menu_bg_color'];
        }else{
            //Transparent menu
            $theone_transparent_menu_picker = fw_get_db_settings_option('theone_transparent_menu_picker');
            $theone_transparent_menu_picker_on = $theone_transparent_menu_picker['on'];
            $theone_menu_bg_color = $theone_transparent_menu_picker_on['theone_menu_bg_color'];
        }
        
        $theone_trn_header_logo = fw_get_db_settings_option('theone_trn_header_logo');
        $theone_trn_header_logo_width = fw_get_db_settings_option('theone_trn_header_logo_width');
...
<header id="header" class="transparent-menu">
    <!-- Main Menu Start -->
    <div class="main-menu" style=" background: <?php echo !empty($theone_menu_bg_color) ? esc_attr($theone_menu_bg_color) : ''; ?>; "  >
        <div class="container">
            <div class="row">
                <nav class="navbar navbar-default">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                            <?php if (! empty($theone_trn_header_logo)): ?>
                                <img style="
                                    width: <?php echo esc_attr($theone_trn_header_logo_width) . "px"; ?>; <?php if ( $theone_Logo_padding_switch == 'on'): ?> padding-top: <?php echo esc_attr($padding_top) . "px"; ?>; padding-right: <?php echo esc_attr($padding_right) . "px"; ?>; padding-bottom: <?php echo esc_attr($padding_bottom) . "px"; ?>; padding-left: <?php echo esc_attr($padding_left) . "px"; ?>;
                                    <?php endif ?>
                                    "  src="<?php echo !empty($theone_trn_header_logo['url']) ? esc_url($theone_trn_header_logo['url']) : ''; ?>">
                            <?php else: ?>
