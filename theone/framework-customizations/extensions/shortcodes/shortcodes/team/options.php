...
$options = array(
    'theone_member_limit'    => array(
        'type'  => 'text',
        'label'  => esc_html__('Member Limit:', 'theone'),
        'desc'  => esc_html__('Number Only', 'theone'),
    ),

    //Select post from
    'theone_team_multi_picker'   => array(
        'type'      => 'multi-picker',
        'label'     => false,
        'desc'      => false,
        'picker'    => array(
        ...
        'choices'   => array(
            'category'   => array(
                'cats'    => array(
                    ...
                    'choices'=> theone_get_member_categories_select(),
                ),
            ),
            'tags'   => array(
                'tag'    => array(
                    ...
                    'choices'=> theone_get_member_tags_select(),
                ),
            ),
        ),
    ),

    'theone_team_order'    => array(
        'type'  => 'select',
