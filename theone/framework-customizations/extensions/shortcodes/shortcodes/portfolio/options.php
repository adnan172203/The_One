...
$options = array(
	'theone_portfolio_count'	=>array(
		'type'	=> 'text',
		'label'	=> esc_html__('Number of photo to show:', 'theone'),
	),
    //Select post from
    'theone_portfolio_multi_picker'   => array(
        'type'      => 'multi-picker',
        'label'     => false,
        'desc'      => false,
        'picker'    => array(
        ...
        'choices'   => array(
            'category'   => array(
                'cats'    => array(
                    ...
                    'choices'=> theone_get_portfolio_categories_select(),
                ),
            ),
            'tags'   => array(
                'tag'    => array(
                    ...
                    'choices'=> theone_get_portfolio_tags_select(),
                ),
            ),
        ),
    ),

    'theone_portfolio_order'    => array(
        'type'  => 'short-select',
    ...
    'theone_portfolio_orderby'    => array(
        'type'  => 'short-select',
    ...
    'theone_portfolio_style'    => array(
        'type'  => 'radio',
        'value' => 'bg-clr',
        'label' => esc_html__( 'Portfolio Style', 'theone'),
        'choices' => array( 
            'bg-clr' => esc_html__('Style 1', 'theone'),
            'style-two' => esc_html__('Style 2', 'theone'),
        ),
        // Display choices inline instead of list
        'inline' => false,
    ),
    'theone_portfolio_text' => array(
        'type'  => 'switch',
        'value' => 'no',
        'label' => esc_html__('Show Title', 'theone'),
        'left-choice' => array(
            'value' => 'no',
