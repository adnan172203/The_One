 ...
 */
function theone_breadcrumb($class = '') {

    // Settings
    $separator	 = '&gt;';
    $breadcrums_id	 = 'breadcrumbs';
    $breadcrums_class	 = 'breadcrumb ' . $class;
    $home_title	 = esc_html__('Home', 'theone');

    // If you have any custom post types with custom taxonomies, put the taxonomy name below (e.g. product_cat)
    $custom_taxonomy     = 'product_cat';
    $custom_taxonomy     = 'pricing_cat';
    $custom_taxonomy     = 'member_cat';
    $custom_taxonomy     = 'service_cat';
    $custom_taxonomy     = 'testimonial_cat';
    $custom_taxonomy	 = 'portfolio_cat';
    ...
    if ( !is_front_page() ) {
        ...
        if ( is_author() ) {
            ...
            // Paginated archives
            echo '<li class="item-current item-current-' . get_query_var('paged') . '"><span class="bread-current bread-current-' . get_query_var('paged') . '" title="Page ' . get_query_var('paged') . '">'.esc_html__('Page','theone') . ' ' . get_query_var('paged') . '</span></li>';
